...
/******************************************************************************
 *  Compilation:  javac daRealDraw.java
 *  Execution:    java daRealDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code daRealDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have <tt>daRealDraw.class</tt> in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "http://introcs.cs.princeton.edu/java/stdlib/daRealDraw.java">daRealDraw.java</a>
 *  and put a copy in your working directory.
 *  <p>
 *  Now, type the following short program into your editor:
 *  <pre>
 *   public class TestdaRealDraw {
 *       public static void main(String[] args) {
 *           daRealDraw.setPenRadius(0.05);
 *           daRealDraw.setPenColor(daRealDraw.BLUE);
 *           daRealDraw.point(0.5, 0.5);
 *           daRealDraw.setPenColor(daRealDraw.MAGENTA);
 *           daRealDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code daRealDraw.line()} and {@code daRealDraw.point()}
 *  draw lines and points; the methods {@code daRealDraw.setPenRadius()}
 *  and {@code daRealDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code daRealDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  </ul>
 *  <p>
 *  For example, {@code daRealDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code daRealDraw.setPenColor(daRealDraw.MAGENTA)} sets the
 ...
 *  For example, {@code daRealDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code daRealDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   daRealDraw.setFont(font);
 *   daRealDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code daRealDraw.clear(daRealDraw.LIGHT_GRAY)} clears the canvas to a shade
 ...
 *  results appear on the screen. {@code daRealDraw.show()} turns off
 *  animation mode.
 *  <p>
 ...
 *       number of objects.
 *       That is, call {@code daRealDraw.show(0)} before
 ...
 *  @author Kevin Wayne
 */
public final class daRealDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static daRealDraw std = new daRealDraw();
    ...
    private static void init() {
        ...
        int stuff = frame.getExtendedState();
        stuff &= JFrame.ICONIFIED;
        frame.setExtendedState(stuff);
    ...
    ***************************************************************************/
     ...
     * <tt>daRealDraw.BLACK</tt>, <tt>daRealDraw.BLUE</tt>, <tt>daRealDraw.CYAN</tt>,
     * <tt>daRealDraw.DARK_GRAY</tt>, <tt>daRealDraw.GRAY</tt>, <tt>daRealDraw.GREEN</tt>,
     * <tt>daRealDraw.LIGHT_GRAY</tt>, <tt>daRealDraw.MAGENTA</tt>, <tt>daRealDraw.ORANGE</tt>,
     * <tt>daRealDraw.PINK</tt>, <tt>daRealDraw.RED</tt>, <tt>daRealDraw.WHITE</tt>, and
     * <tt>daRealDraw.YELLOW</tt>.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to daRealDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = daRealDraw.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(daRealDraw.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            daRealDraw.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = daRealDraw.userX(e.getX());
            mouseY = daRealDraw.userY(e.getY());
            mousePressed = true;
        }
    }
    ...
    *  as an argument. It can handle action keys
     ...
     */
    public static void main(String[] args) {
        daRealDraw.square(.2, .8, .1);
        daRealDraw.filledSquare(.8, .8, .2);
        daRealDraw.circle(.8, .2, .2);

        daRealDraw.setPenColor(daRealDraw.BOOK_RED);
        daRealDraw.setPenRadius(.02);
        daRealDraw.arc(.8, .2, .1, 200, 45);

        // draw a blue diamond
        daRealDraw.setPenRadius();
        daRealDraw.setPenColor(daRealDraw.BOOK_BLUE);
        double[] x = { .1, .2, .3, .2 };
        double[] y = { .2, .3, .2, .1 };
        daRealDraw.filledPolygon(x, y);

        // text
        daRealDraw.setPenColor(daRealDraw.BLACK);
        daRealDraw.text(0.2, 0.5, "black text");
        daRealDraw.setPenColor(daRealDraw.WHITE);
        daRealDraw.text(0.8, 0.8, "white text");
    }
